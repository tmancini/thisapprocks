...
/**
 * This is basically copied from the CodenameOne MultiButton class. The
 * fourthRow is a SpanLabel instead of just a regular Label to account for a
 * long description
 *
 */
public class CustomMultiButton extends Container {
	 ...
	 *            first line of text
	 */
	public CustomMultiButton(String line1) {
		this();
		setTextLine1(line1);
	}
	...
	/**
	 * Allows us to gain direct access to the icon component so we can set it
	 * directly without going via the other methods, this is especially useful for
	 * classes such as the ImageDownloadService which can then update the icon
	 * seamlessly.
	 * 
	 ...
	 * This only works in horizontal mode!
	 * 
	 * @return true when the second row entry should be placed before the first
	 *         entry
	 */
	...
	public String[] getPropertyNames() {
		return new String[] { "line1", "line2", "line3", "line4", "name1", "name2", "name3", "name4", "uiid1", "uiid2",
				"uiid3", "uiid4", "icon", "iconName", "iconUiid", "iconPosition", "emblem", "emblemName", "emblemUiid",
				"emblemPosition", "horizontalLayout", "invertFirstTwoEntries", "checkBox", "radioButton", "group",
				"selected", "maskName" };
	}
	...
	public Class[] getPropertyTypes() {
		return new Class[] { String.class, // line1
				String.class, // line2
				String.class, // line3
				String.class, // line4
				String.class, // name1
				...
				Boolean.class, Boolean.class, Boolean.class, Boolean.class, String.class, // group
	 ...
	 * all text is localized so this allows disabling automatic localization for a
	 * specific component.
	 * 
